...
def test_formal_safe_reference_gate_matches_specification():
    ...
    assert "--transport_obstacle_clearance 0.001" in runner
    assert "--transport_obstacle_segments 8" in runner
    assert "--transport_arc_position_tolerance 0.032" in runner
    ...
    assert "--transport_clearance 0.00" in runner
    ...
    assert "--postorientation_position_tolerance 0.0275" in runner
