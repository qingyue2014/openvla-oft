...
#SBATCH --output=/project/trllmout/physcog-runs/openvla-oft-l1c4/.physcog-agent/worktrees/81cd88596e72a0c879f111cb143873175f880920/.physcog-agent/jobs/20260811T101948Z-l1c5-pi05_smoke_model_informed_v1.out
#SBATCH --error=/project/trllmout/physcog-runs/openvla-oft-l1c4/.physcog-agent/worktrees/81cd88596e72a0c879f111cb143873175f880920/.physcog-agent/jobs/20260811T101948Z-l1c5-pi05_smoke_model_informed_v1.out
source /etc/profile.d/modules.sh
module avail
module load slurm "nvhpc-hpcx-cuda12/23.11"
set -uo pipefail
cd /project/trllmout/physcog-runs/openvla-oft-l1c4/.physcog-agent/worktrees/81cd88596e72a0c879f111cb143873175f880920
