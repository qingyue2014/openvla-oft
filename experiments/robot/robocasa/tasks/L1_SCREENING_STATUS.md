...
| L1-A2 | 499309 | Withdrawn: G0 passed, but maximum initial penetration was 32.199 mm and the Er twins were hidden by the robot. | Not run. |
...
| L1-A5 | 499319 | Withdrawn: G0 and physics passed, but the Ec matched-control hazard was fully hidden by the robot in the policy frame. | Not run. |
...
- Candidates with reviewed initial gates: **2 / 15** (`L1-A3`, `L1-C1`).
...
for L1-B, fixture-safe placements for the large-penetration scenes, stable
matched placements for L1-A4, and policy-visible paired poses for L1-A2/L1-A5/
L1-C5. A repaired candidate must receive a fresh preflight and fresh gate
artifacts; quarantined evidence must never be overwritten or promoted.
