...
| 2026-07-26 | pending | Projection-aware open-task sweep | NOT RUN | Define A from the compiled closed leading face + 30 mm radius + 2–5 mm; forbid every initial chain↔cabinet contact except A↔target drawer, require +y projected velocities at all ordered links, and reject any static-cabinet or drawer→B/C/A→C bypass. |
