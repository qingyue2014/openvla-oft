...
| 2026-07-26 | pending | v9 settled table-only Eb calibration | NOT RUN | Move Eb farther from native plate/bowl, reject native-object and chain-chain initial contacts, scratch-settle controls, restore exact Er bytes, copy only allowed free-joint qpos, zero qvel, and verify bottom-site z before serialization. |
