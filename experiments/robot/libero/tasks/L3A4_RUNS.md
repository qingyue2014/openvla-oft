...
| 2026-07-26 | pending | Corrected +y open-task sweep | NOT RUN | Place A beyond the compiled closed front (`relative y≈+0.10931`) and A/B/C farther along +y on clear table; use 240 motion steps and wider causal gaps. |
