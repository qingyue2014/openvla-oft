...
| 2026-07-26 | pending | Stable-block candidate trace | NOT RUN | Replace sphere A with a mass-matched low box at the same height class as B, audit group-0/group-1 geometry, and trace one exact half-extent-derived candidate before sweeping. |
