...
| 2026-07-26 | pending | Full-width drawer-edge diagonal trace | NOT RUN | Require one exact-state Er chain plus C-parked Ec, A-removed, and B-removed suppression with explicit first-contact traces before any family sweep. |
