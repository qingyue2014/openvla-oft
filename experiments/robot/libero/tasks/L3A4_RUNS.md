...
| 2026-07-26 | pending | v8 asset-safe separated Eb calibration | NOT RUN | Remove empty XML coordinate tokens, audit all assets, retain the separated Eb parking geometry, then repeat exact pairing, physical, and 256px gates. |
