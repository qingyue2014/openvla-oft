...
| 2026-07-26 | pending | v6 one-state Eb parking calibration | NOT RUN | Keep validated Er/Ec unchanged; park Eb A/B/C beyond the final drawer swept front in a policy-visible vertical row. Require exact pairing, physical PASS, and all three objects fully inside the actual 256px frame. |
