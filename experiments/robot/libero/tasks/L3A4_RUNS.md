...
| 2026-07-26 | pending | Drawer-edge diagonal trace | NOT RUN | Put A across the compiled +x drawer edge while B/C lie outside the swept width. Require one exact-state Er chain plus C-parked Ec, A-removed, and B-removed suppression with explicit first-contact traces before any family sweep. |
