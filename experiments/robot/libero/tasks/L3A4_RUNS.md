...
| 2026-07-26 | pending | Stable-block paired sweep | NOT RUN | Run five 1 mm-neighborhood candidates × five reset states for Er, C-parked Ec, A-removed, and B-removed. Ec must preserve ordered upstream links without bypass; both ablations must suppress C response; family eligibility must be at least 80%. |
