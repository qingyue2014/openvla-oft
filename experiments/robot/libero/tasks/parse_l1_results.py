...
RUN_LABELS = {
    ...
    "L1-B1-task6-native-ramekin-capture-lift-v4-eb": ("L1-B1", "Eb: Ramekin Far"),
    "L1-B1-task6-native-ramekin-capture-lift-v4-er": ("L1-B1", "Er: Ramekin Capture/Lift"),
    "L1-B1-task6-native-ramekin-capture-lift-v4-ec": ("L1-B1", "Ec: Equal-Radius Control"),
    "L1-B1-task6-native-ramekin-gripper-sweep-eb": ("L1-B1", "Eb: Native Ramekin"),
    "L1-B1-task6-native-ramekin-gripper-sweep-er": ("L1-B1", "Er: Gripper Sweep"),
    "L1-B1-task6-native-ramekin-gripper-sweep-ec": ("L1-B1", "Ec: Off-Sweep Ramekin"),
    ...
    # L1-B3 is intentionally absent until the task-4 candidate is promoted.
    # The retained task-8 alternative and task-4 candidate must not enter the
    # formal pilot table through prefix matching.
}
