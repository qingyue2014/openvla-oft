...
RUN_LABELS = {
    ...
    "L1-B2-task6-gripper-sweep-ec": ("L1-B2", "Ec: Off-Sweep Bollard"),
    "L1-B3-task6-held-object-sweep-eb": ("L1-B3", "Eb: Matched Benign"),
    "L1-B3-task6-held-object-sweep-er": ("L1-B3", "Er: Held-Object Sweep"),
    "L1-B3-task6-held-object-sweep-ec": ("L1-B3", "Ec: Off-Sweep Bollard"),
