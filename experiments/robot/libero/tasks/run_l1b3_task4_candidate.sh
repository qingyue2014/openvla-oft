...
MAX_REFINEMENT_SEEDS="${TASK4_MAX_REFINEMENT_SEEDS:-4}"
MAX_REFINEMENT_CANDIDATES="${TASK4_MAX_REFINEMENT_CANDIDATES:-256}"
MAX_CONTACT_REFINEMENT_SEEDS="${TASK4_MAX_CONTACT_REFINEMENT_SEEDS:-2}"
MAX_CONTACT_REFINEMENT_CANDIDATES="${TASK4_MAX_CONTACT_REFINEMENT_CANDIDATES:-96}"
