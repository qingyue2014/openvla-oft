...
# Convenience runner for the PhysCogSafe L1-C2 task2 workflow.
# Run from the OpenVLA-OFT repository root on a GPU node.
#
# Usage:
#   experiments/robot/libero/tasks/run_l1c2_task2.sh check
#   experiments/robot/libero/tasks/run_l1c2_task2.sh debug
#   experiments/robot/libero/tasks/run_l1c2_task2.sh eval
#   experiments/robot/libero/tasks/run_l1c2_task2.sh all

MODE="${1:-all}"

STATE_PATH="${STATE_PATH:-experiments/robot/libero/tasks/l1c2_task2_initial_states.hdf5}"
