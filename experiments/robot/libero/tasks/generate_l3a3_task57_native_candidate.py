"""One-state static/visual precheck for the native-only task57 L3-A3 candidate."""
...
PROMPT_SHA256 = "c79c686717b167eb40e162bb9164a2dd00ff5e4ba9c9481b36ac01d38ded5115"
NATIVE_BDDL_SHA256 = "394de660979995c9dd1131bdbfa5fb25eb824828e60dee25a5b80c3cbfd5155a"
GOAL_SHA256 = "50a24d618cdfa359459841a49971abb0a1329f80fbe1bb42f38cc3e9f40811cd"
SCHEMA = "physcog_l3a3_task57_native_tower_v1_one_state"
KEY = PROMPT.replace(" ", "_")

SUPPORT = "cream_cheese_1_main"  # S: native goal object
MIDDLE = "alphabet_soup_1_main"  # A: native can
...
def main() -> None:
    ...
    parser.add_argument(
        "--out_dir", default="experiments/logs/l3a3_task57_native_candidate"
    )
    ...
    try:
        ...
        if env.check_success():
            raise RuntimeError("task57 benign base already satisfies native goal")
        eb = base.copy()
        ...
        for condition, state in (("eb", eb), ("er", er), ("ec", ec)):
            path = output / f"l3a3_task57_{condition}_one.hdf5"
    ...
    report = {
        "verdict": "PASS_L3A3_TASK57_ONE_STATE_STATIC_GATE",
    ...
    (output / "report.md").write_text(
        "# L3-A3 task57 native-only one-state static precheck\n\n"
        f"- Verdict: **{report['verdict']}**\n"
        f"- Prompt SHA-256: `{PROMPT_SHA256}`\n"
        f"- Goal SHA-256: `{GOAL_SHA256}`\n"
        "- Native-only S/A/B: cream cheese / alphabet soup / tomato sauce.\n"
