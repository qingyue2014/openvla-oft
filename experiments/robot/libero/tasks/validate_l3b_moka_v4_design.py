"""Validate the locked wider-slot L3-B moka v4 design."""
...
PREREGISTRATION_ID = "l3b_moka_v4_wider_slots_pool_v1"
STATUS = "LOCKED_AFTER_V3_EC_FAILURE_BEFORE_V4_RERUN"
SCOPE = "matched_v4_wider_slots_capability_conditioned_pool"
...
def validate_spec(path: str | Path) -> dict:
    ...
    checks = {
        ...
        "geometry": (
            geometry.get("old_slot_separation_m") == 0.105
            and geometry.get("new_slot_separation_m") == SLOT_SEPARATION_M
            and geometry.get("threshold_changes_from_v3") is False
            and geometry.get(
    ...
    if failures:
        raise ValueError(
            "L3-B moka v4 design preregistration mismatch: "
            + ", ".join(failures)
        )
    return {
        ...
        "verdict": "PASS_L3B_MOKA_V4_DESIGN_PREREGISTRATION",
    }
...
def main() -> None:
    ...
    print(
        ...
        f"separation={result['slot_separation_m']} "
