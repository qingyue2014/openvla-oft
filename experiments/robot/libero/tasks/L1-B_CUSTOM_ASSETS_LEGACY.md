# Retired L1-B Custom-Asset Specification

> **Retired on 2026-07-24.** The custom sweep-post, gripper-pin, bollard, and
> goal-gate families in this document are no longer active L1-B scenarios.
> Canonical L1-B1/B2/B3 now use the former native-asset B5/B6/B7 designs. See
> `L1-B_SPEC.md`. This file is retained only to explain historical artifacts.
