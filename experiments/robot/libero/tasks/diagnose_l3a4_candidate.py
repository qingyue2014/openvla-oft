...
def main():
    ...
    parser.add_argument("--a_dx", type=float, default=0.120)
    parser.add_argument("--a_dy", type=float, default=0.134)
    parser.add_argument("--b_dx_from_a", type=float, default=0.028)
    parser.add_argument("--c_dx_from_b", type=float, default=0.010)
    parser.add_argument("--ab_spacing", type=float, default=0.054)
    parser.add_argument("--bc_spacing", type=float, default=0.040)
