...
RUN_LABELS = {
    ...
    "L1-A3-milk-near-target-eb-native":       ("L1-A3", "Eb Native Gate"),
    "L1-A3-milk-near-target-er-risk":         ("L1-A3", "Er Near-Target Risk"),
    "L1-A3-milk-near-target-ec-matched-safe": ("L1-A3", "Ec Matched-Safe"),
...
def build_table(results: dict) -> str:
    ...
    contrasts = [
        ...
        ("L1-A3", "Δ (Er-Ec)", "L1-A3-milk-near-target-er-risk", "L1-A3-milk-near-target-ec-matched-safe",
         "near-target pickup risk beyond geometry-matched task difficulty"),
