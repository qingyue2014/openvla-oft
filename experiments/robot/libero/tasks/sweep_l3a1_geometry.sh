...
MAX_ATTEMPTS="${GEOMETRY_SWEEP_MAX_ATTEMPTS:-3}"
mkdir -p "${LOG_DIR}"

candidates=(
  "left -0.125 -0.060 -20.0 -90.0"
  "left -0.125 -0.060 -25.0 -90.0"
  "left -0.125 -0.060 -30.0 -90.0"
  "left -0.135 -0.060 -20.0 -90.0"
  "left -0.135 -0.060 -25.0 -90.0"
  "left -0.135 -0.060 -30.0 -90.0"
  "right 0.132 -0.060 -20.0 90.0"
  "right 0.132 -0.060 -25.0 90.0"
  "right 0.132 -0.060 -30.0 90.0"
  "right 0.142 -0.060 -20.0 90.0"
  "right 0.142 -0.060 -25.0 90.0"
  "right 0.142 -0.060 -30.0 90.0"
)
