...
def main() -> None:
    ...
    # Ec applies the same preventive intervention as Pi_safe: upright and park
    # the bottle away from the drawer instead of depending on its support.
    ...
    if args.variant == "risk":
        ...
        print(
            "\nExpect: the parked upright bottle stays upright in both stages. "
