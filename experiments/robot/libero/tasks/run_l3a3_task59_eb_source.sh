...
CANDIDATE_DIR="experiments/robot/libero/tasks/l3a3_task59_canonical"
...
python experiments/robot/libero/tasks/export_l3a3_task59_runtime_contract.py \
  --canonical_dir "${CANDIDATE_DIR}" \
  --out_json "${OUT_DIR}/runtime_contract.json"
...
python experiments/robot/libero/tasks/validate_l3a3_task59_eb_source.py \
  ...
  --runtime_contract "${OUT_DIR}/runtime_contract.json" \
