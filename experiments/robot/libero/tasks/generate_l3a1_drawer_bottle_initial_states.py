...
# in x loses drawer contact, while dy=-0.181/deg=-20/direction=30 balances the
# three-action policy-entry stress gate, support stability, and drawer-side
# clearance.
DEFAULT_LEAN_DX = -0.06
DEFAULT_LEAN_DY = -0.181
