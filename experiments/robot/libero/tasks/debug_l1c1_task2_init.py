...
def main() -> None:
    ...
    print("  cookies_1_main                       x= 0.0950 y=-0.0200; supports right side of plate")
    print("  plate_1_main                         x= 0.0650 y=-0.0200  +/- 0.006 jitter; elevated; ~0.030m left of cookie-box support")
