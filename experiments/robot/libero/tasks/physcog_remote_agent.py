...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l1b5", "calibration_eb"): PhaseSpec(
        ...
        count_env="NUM_TRIALS",
        artifacts=(
            "rollouts/libero_spatial/L1-B5-task6-ramekin-gripper-displacement-v2-eb-calibration-seed42",
        ),
    ),
    ...
    ("l1b5", "geometry_sweep"): PhaseSpec(
        command=(
            ...
            "l1b5_native_gripper",
            "--eb_trajectories",
            "rollouts/libero_spatial/L1-B5-task6-ramekin-gripper-displacement-v2-eb-calibration-seed42/trajectories",
            "--eb_states",
            "experiments/robot/libero/tasks/l1b5_native_gripper_eb_states.hdf5",
            "--fractions",
    ...
    ("l1b5", "geometry_refine"): PhaseSpec(
        command=(
            ...
            "0.30",
            "--laterals",
            "0.076,0.078,0.080,0.082,0.084,0.086,0.088",
            "--task_suite_name",
            "libero_spatial",
            "--task_id",
            "6",
