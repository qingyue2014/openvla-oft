...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l3b1", "cosmos_prepare"): PhaseSpec(
        command=(
            ...
            "MAX_VIDEOS_PER_OUTCOME=10",
            "bash",
            "experiments/robot/libero/tasks/run_cosmos_l3b1.sh",
            "prepare",
        ),
        count_env="NUM_STATES",
        artifacts=(
            "experiments/logs/l3b1_cosmos_runtime.md",
            "experiments/logs/l3b1_cosmos_native_preflight.md",
            "experiments/logs/l3b1_cosmos_capability_native_preflight.md",
            "experiments/logs/l3b1_cosmos_native_capability_states.md",
            "experiments/logs/l3b1_cosmos_state_pairing.md",
            "experiments/logs/l3b1_cosmos_reference_paths.md",
            "experiments/robot/libero/tasks/l3b1_native_capability_states.hdf5",
            "experiments/robot/libero/tasks/l3b1_eb_native_states.hdf5",
            "experiments/robot/libero/tasks/l3b1_risk_states.hdf5",
            "experiments/robot/libero/tasks/l3b1_ec_clearance_states.hdf5",
            "experiments/robot/libero/tasks/l3b1_native_capability_preview",
            "experiments/robot/libero/tasks/l3b1_formal_preview",
        ),
    ),
    ("l3b1", "cosmos_native_cap_smoke"): PhaseSpec(
        command=(
            "env",
            "RENDER_GPU_DEVICE_ID=1",
            "SAVE_VIDEO_MODE=all",
        ...
        artifacts=(
            ...
            "experiments/logs/l3b1_cosmos_capability_native_preflight.md",
            "experiments/logs/l3b1_cosmos_native_capability_states.md",
            "experiments/logs/l3b1_cosmos_native_capability_smoke.md",
            "rollouts/libero_90/L3-B1-cosmos-native-wine-bottle-to-rack-smoke",
        ),
    ),
    ("l3b1", "cosmos_native_cap_formal"): PhaseSpec(
        command=(
            "env",
            "RENDER_GPU_DEVICE_ID=1",
            "SAVE_VIDEO_MODE=all",
        ...
        artifacts=(
            ...
            "experiments/logs/l3b1_cosmos_native_capability_states.md",
            "experiments/logs/l3b1_cosmos_native_capability_smoke.md",
            "rollouts/libero_90/L3-B1-cosmos-native-wine-bottle-to-rack",
        ),
    ),
    ("l3b1", "cosmos_smoke"): PhaseSpec(
        command=(
            "env",
            "RENDER_GPU_DEVICE_ID=1",
            "SAVE_VIDEO_MODE=all",
        ...
        artifacts=(
            ...
            "experiments/logs/l3b1_cosmos_state_pairing.md",
            "experiments/logs/l3b1_cosmos_reference_paths.md",
            "experiments/logs/l3b1_cosmos_smoke_evidence.md",
            "rollouts/libero_90/L3-B1-cosmos-drawer-close-eb-native-smoke",
            "rollouts/libero_90/L3-B1-cosmos-bottle-in-drawer-risk-smoke",
            "rollouts/libero_90/L3-B1-cosmos-bottle-in-drawer-ec-clearance-smoke",
        ),
    ),
    ("l3b1", "cosmos_formal"): PhaseSpec(
        command=(
            "env",
            "RENDER_GPU_DEVICE_ID=1",
            "SAVE_VIDEO_MODE=all",
        ...
        artifacts=(
            ...
            "experiments/logs/l3b1_cosmos_reference_paths.md",
            "experiments/logs/l3b1_cosmos_smoke_evidence.md",
            "rollouts/libero_90/L3-B1-cosmos-drawer-close-eb-native",
            "rollouts/libero_90/L3-B1-cosmos-bottle-in-drawer-risk",
            "rollouts/libero_90/L3-B1-cosmos-bottle-in-drawer-ec-clearance",
        ),
    ),
    ("l3b1", "cosmos_summarize"): PhaseSpec(
        command=(
            "bash",
            "experiments/robot/libero/tasks/run_cosmos_l3b1.sh",
            "summarize",
    ...
    ("l3b1", "cosmos_direct_prepare"): PhaseSpec(
        command=(
            "env",
            "RENDER_GPU_DEVICE_ID=1",
            "SAVE_VIDEO_MODE=all",
    ...
    ("l3b1", "cosmos_direct_smoke"): PhaseSpec(
        command=(
            "env",
            "RENDER_GPU_DEVICE_ID=1",
            "SAVE_VIDEO_MODE=all",
        ...
        artifacts=(
            ...
            "experiments/logs/l3b1_cosmos_reference_paths.md",
            "experiments/logs/l3b1_cosmos_smoke_evidence.md",
            "rollouts/libero_90/L3-B1-cosmos-direct-drawer-close-eb-native-smoke",
            "rollouts/libero_90/L3-B1-cosmos-direct-bottle-in-drawer-risk-smoke",
            "rollouts/libero_90/L3-B1-cosmos-direct-bottle-in-drawer-ec-clearance-smoke",
        ),
    ),
    ("l3b1", "cosmos_direct_formal"): PhaseSpec(
        command=(
            "env",
            "RENDER_GPU_DEVICE_ID=1",
            "SAVE_VIDEO_MODE=all",
        ...
        artifacts=(
            ...
            "experiments/logs/l3b1_cosmos_reference_paths.md",
            "experiments/logs/l3b1_cosmos_smoke_evidence.md",
            "rollouts/libero_90/L3-B1-cosmos-direct-drawer-close-eb-native",
            "rollouts/libero_90/L3-B1-cosmos-direct-bottle-in-drawer-risk",
            "rollouts/libero_90/L3-B1-cosmos-direct-bottle-in-drawer-ec-clearance",
        ),
    ),
    ("l3b1", "cosmos_direct_summarize"): PhaseSpec(
        command=(
            "bash",
            "experiments/robot/libero/tasks/run_cosmos_l3b1.sh",
            "direct_summarize",
