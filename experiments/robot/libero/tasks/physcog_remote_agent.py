...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l1a3", "smoke"): PhaseSpec(
        ...
        artifacts=(
            ...
            "review/L1-A3_task/milk_near_orange_juice_v2",
            "experiments/logs/l1a3_native_preflight.md",
            "experiments/robot/libero/tasks/l1a3_native_preflight.json",
            "experiments/robot/libero/tasks/l1a3_pairing.json",
            "experiments/robot/libero/tasks/l1a3_eb_states.hdf5",
            ...
            "experiments/robot/libero/tasks/l1a3_ec_states.hdf5",
            "experiments/robot/libero/tasks/l1a3_preview",
            "rollouts/libero_object/L1-A3-v2-milk-orange-juice-eb-native-smoke",
            "rollouts/libero_object/L1-A3-v2-milk-orange-juice-er-risk-smoke",
            "rollouts/libero_object/L1-A3-v2-milk-orange-juice-ec-matched-safe-smoke",
        ),
    ),
    ("l1a3", "smoke_pi05"): PhaseSpec(
        command=(
            "env",
            ...
            "bash",
            "experiments/robot/libero/tasks/run_l1a3_pi05.sh",
            "smoke",
        ),
        count_env="SMOKE_TRIALS",
        artifacts=(
            "experiments/logs/l1a3_pi05/pi05_server.log",
            "experiments/logs/l1a3_pi05/l1a3_eb_to_er_replay_smoke.md",
            "experiments/logs/l1a3_pi05/l1a3_eb_to_er_replay_smoke.csv",
            "experiments/logs/l1a3_pi05/l1a3_safe_reference_smoke.md",
            "experiments/logs/l1a3_pi05/l1a3_safe_reference_smoke.csv",
            "review/L1-A3_task/milk_near_orange_juice_v2/pi05",
            "experiments/logs/l1a3_pi05/l1a3_native_preflight.md",
            "experiments/robot/libero/tasks/l1a3_native_preflight.json",
            "experiments/robot/libero/tasks/l1a3_pairing.json",
            "experiments/robot/libero/tasks/l1a3_eb_states.hdf5",
            "experiments/robot/libero/tasks/l1a3_er_states.hdf5",
            ...
            "rollouts/libero_object/L1-A3-v2-milk-orange-juice-er-risk-pi05-smoke",
            "rollouts/libero_object/L1-A3-v2-milk-orange-juice-ec-matched-safe-pi05-smoke",
        ),
    ),
    ("l1a3", "formal"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/experiment_records.md",
            "experiments/logs/result_tables.md",
            "rollouts/libero_object/L1-A3-v2-milk-orange-juice-eb-native",
            "rollouts/libero_object/L1-A3-v2-milk-orange-juice-er-risk",
            "rollouts/libero_object/L1-A3-v2-milk-orange-juice-ec-matched-safe",
        ),
    ),
