...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l3a1", "corridor_sweep"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l3a1_corridor_dx-0.090_check.md",
            "experiments/logs/l3a1_corridor_dx-0.095_check.md",
            "experiments/logs/l3a1_corridor_dx-0.100_check.md",
            "experiments/logs/l3a1_corridor_dx-0.090_risk_states.hdf5",
            "experiments/logs/l3a1_corridor_dx-0.095_risk_states.hdf5",
            "experiments/logs/l3a1_corridor_dx-0.100_risk_states.hdf5",
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-dx-0.090",
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-dx-0.095",
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-dx-0.100",
        ),
    ),
