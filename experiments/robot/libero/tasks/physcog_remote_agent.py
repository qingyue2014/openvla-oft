...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l3a1", "geometry_sweep"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l3a1_sweep_left_dx-0.125_dy-0.060_deg-20.0_direction-90.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.125_dy-0.060_deg-25.0_direction-90.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.125_dy-0.060_deg-30.0_direction-90.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.135_dy-0.060_deg-20.0_direction-90.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.135_dy-0.060_deg-25.0_direction-90.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.135_dy-0.060_deg-30.0_direction-90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.132_dy-0.060_deg-20.0_direction90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.132_dy-0.060_deg-25.0_direction90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.132_dy-0.060_deg-30.0_direction90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.142_dy-0.060_deg-20.0_direction90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.142_dy-0.060_deg-25.0_direction90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.142_dy-0.060_deg-30.0_direction90.0.log",
        ),
    ),
