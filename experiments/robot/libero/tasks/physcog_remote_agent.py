...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l1c2", "pilot"): PhaseSpec(
        command=(
            "env", "RENDER_GPU_DEVICE_ID=1", "SAVE_VIDEO_MODE=all",
            "MAX_VIDEOS_PER_OUTCOME=8", "bash",
    ...
    ("l1c3", "init"): PhaseSpec(
        command=(
            "env", "RENDER_GPU_DEVICE_ID=1", "bash",
            "experiments/robot/libero/tasks/run_l1c3_occupied_drawer.sh", "check",
        ),
        count_env="NUM_TRIALS",
        artifacts=(
            "experiments/robot/libero/tasks/l1c3_eb_states.hdf5",
            "experiments/robot/libero/tasks/l1c3_er_states.hdf5",
    ...
    ("l1c3", "preview"): PhaseSpec(
        command=(
            "env", "RENDER_GPU_DEVICE_ID=1", "bash",
            "experiments/robot/libero/tasks/run_l1c3_occupied_drawer.sh", "preview",
        ),
        count_env="PREVIEW_NUM_STATES",
        artifacts=(
    ...
    ("l1c3", "validate_layout"): PhaseSpec(
        command=(
            "env", "RENDER_GPU_DEVICE_ID=1", "bash",
            "experiments/robot/libero/tasks/run_l1c3_occupied_drawer.sh", "validate_layout",
        ),
        count_env="NUM_TRIALS",
        artifacts=(
    ...
    ("l1c3", "policy_probe"): PhaseSpec(
        command=(
            "env", "RENDER_GPU_DEVICE_ID=1", "SAVE_VIDEO_MODE=none", "bash",
            "experiments/robot/libero/tasks/run_l1c3_occupied_drawer.sh", "policy_probe",
        ),
        count_env="NUM_TRIALS",
        artifacts=(
    ...
    ("l1c3", "safe_reference"): PhaseSpec(
        command=(
            "env", "RENDER_GPU_DEVICE_ID=1", "bash",
            "experiments/robot/libero/tasks/run_l1c3_occupied_drawer.sh", "safe_reference",
        ),
        count_env="CALIBRATION_NUM_STATES",
        artifacts=(
    ...
    ("l1c3", "action_replay"): PhaseSpec(
        command=(
            "env", "RENDER_GPU_DEVICE_ID=1", "bash",
            "experiments/robot/libero/tasks/run_l1c3_occupied_drawer.sh", "replay",
        ),
        artifacts=(
            "experiments/logs/l1c3_eb_to_er_replay.csv",
    ...
    ("l1c3", "pilot"): PhaseSpec(
        command=(
            "env", "RENDER_GPU_DEVICE_ID=1", "SAVE_VIDEO_MODE=all",
            "MAX_VIDEOS_PER_OUTCOME=8", "bash",
            "experiments/robot/libero/tasks/run_l1c3_occupied_drawer.sh", "eval",
        ),
        count_env="NUM_TRIALS",
        artifacts=(
            "experiments/logs/l1c3_native_preflight.json",
            ...
            "experiments/logs/l1c3_eb_to_ec_replay.csv",
            "experiments/logs/l1c3_eb_to_ec_replay.md",
            "experiments/logs/l1c3_attribution.csv",
            "experiments/logs/l1c3_attribution.md",
            "experiments/logs/experiment_records.csv",
            "experiments/logs/experiment_records.md",
            "experiments/logs/result_tables.md",
            "rollouts/libero_90/L1-C3-occupied-drawer-eb",
            "rollouts/libero_90/L1-C3-occupied-drawer-risk",
            "rollouts/libero_90/L1-C3-occupied-drawer-ec",
        ),
    ),
    ("l1c3", "formal"): PhaseSpec(
        command=(
            "env", "RENDER_GPU_DEVICE_ID=1", "SAVE_VIDEO_MODE=all",
            "MAX_VIDEOS_PER_CONDITION=10", "bash",
            "experiments/robot/libero/tasks/run_l1c3_occupied_drawer.sh", "eval",
