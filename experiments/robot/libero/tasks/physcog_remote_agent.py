...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l3a1", "geometry_sweep"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l3a1_sweep_left_dx-0.145_dy-0.055_deg-30.0_direction-90.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.150_dy-0.060_deg-30.0_direction-90.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.155_dy-0.065_deg-30.0_direction-90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.152_dy-0.055_deg-30.0_direction90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.157_dy-0.060_deg-30.0_direction90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.162_dy-0.065_deg-30.0_direction90.0.log",
        ),
    ),
