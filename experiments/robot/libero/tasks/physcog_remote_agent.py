...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l1a4s", "smoke_pi05"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l1a4_spatial_safe_reference_smoke_videos",
    ...
    ("l1a4s", "formal_pi05"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l1a4_spatial_safe_reference_videos",
    ...
    ("l1a4", "check"): PhaseSpec(
        ...
        count_env="NUM_TRIALS",
        artifacts=(
            "experiments/logs/l1a4_native_preflight.md",
            "experiments/robot/libero/tasks/l1a4_native_preflight.json",
            "experiments/robot/libero/tasks/l1a4_pairing.json",
            "experiments/robot/libero/tasks/l1a4_eb_states.hdf5",
            "experiments/robot/libero/tasks/l1a4_er_states.hdf5",
            "experiments/robot/libero/tasks/l1a4_ec_states.hdf5",
            "experiments/robot/libero/tasks/l1a4_preview",
        ),
    ),
    ("l1a4", "preview"): PhaseSpec(
        command=(
            "bash",
            "experiments/robot/libero/tasks/run_l1a4.sh",
            "preview",
    ...
    ("l1a4", "certify"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l1a4_scripted_ec_reference.md",
            "experiments/logs/l1a4_scripted_ec_reference.csv",
    ...
    ("l1a4", "eb_capability_130"): PhaseSpec(
        command=(
            "env",
            "CHECKPOINT=RLinf/RLinf-OpenVLAOFT-LIBERO-130",
            "DO_SAMPLE=True",
            "TEMPERATURE=1.6",
            "TOP_P=1.0",
            "RENDER_GPU_DEVICE_ID=1",
        ...
        count_env="EB_CAPABILITY_TRIALS",
        artifacts=(
            "rollouts/libero_90/L1-A4-middle-bowl-eb-native-libero130-capability",
        ),
    ),
    ("l1a4", "eb_capability_vqvla"): PhaseSpec(
        command=(
            "env",
            ...
            "SAVE_VIDEO_MODE=none",
            "SAVE_TRAJECTORY=True",
            "EB_CAPABILITY_NOTE_SUFFIX=vqvla-capability",
        ...
        count_env="EB_CAPABILITY_TRIALS",
        artifacts=(
            "rollouts/libero_90/L1-A4-middle-bowl-eb-native-vqvla-capability",
        ),
    ),
    ("l1a4", "eb_capability_pi05"): PhaseSpec(
        command=(
            "env",
            "OPENPI_ROOT=/home/drwqyhappy/04-mycode/openpi-15a9616",
            "RENDER_GPU_DEVICE_ID=1",
            "SAVE_VIDEO_MODE=none",
            "SAVE_TRAJECTORY=True",
            "EB_CAPABILITY_NOTE_SUFFIX=pi05-capability",
            "bash",
            "experiments/robot/libero/tasks/run_l1a4_pi05_capability.sh",
        ),
        count_env="EB_CAPABILITY_TRIALS",
        artifacts=(
            "experiments/logs/l1a4_pi05_server.log",
            "rollouts/libero_90/L1-A4-middle-bowl-eb-native-pi05-capability",
        ),
    ),
    ...
    ("l1a4", "smoke"): PhaseSpec(
        ...
        count_env="SMOKE_TRIALS",
        artifacts=(
            "experiments/logs/l1a4_scripted_eb_reference_smoke.md",
            "experiments/logs/l1a4_scripted_eb_reference_smoke.csv",
            "experiments/logs/l1a4_scripted_eb_reference_smoke_videos",
            "experiments/logs/l1a4_eb_to_er_replay_smoke.md",
            "experiments/logs/l1a4_eb_to_er_replay_smoke.csv",
            "experiments/logs/l1a4_safe_reference_smoke.md",
            "experiments/logs/l1a4_safe_reference_smoke.csv",
            "experiments/logs/l1a4_safe_reference_smoke_videos",
            "experiments/logs/l1a4_scripted_ec_reference_smoke.md",
            "experiments/logs/l1a4_scripted_ec_reference_smoke.csv",
            "experiments/logs/l1a4_scripted_ec_reference_smoke_videos",
    ...
    ("l1a4", "formal"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l1a4_scripted_ec_reference.csv",
            "experiments/logs/l1a4_scripted_ec_reference_videos",
            "experiments/logs/l1a4_attribution.md",
            "experiments/logs/experiment_records.csv",
            "experiments/logs/experiment_records.md",
            "experiments/logs/result_tables.md",
            "rollouts/libero_90/L1-A4-middle-bowl-eb-native",
            "rollouts/libero_90/L1-A4-middle-bowl-ordinal-shift-er",
            "rollouts/libero_90/L1-A4-middle-bowl-matched-safe-ec",
        ),
    ),
    ("l1a4", "attribution"): PhaseSpec(
        command=(
            "bash",
            "experiments/robot/libero/tasks/run_l1a4.sh",
            "attribution",
...
def build_batch_script(
    ...
    lines = [
        ...
        *(
        ...
        # Numba otherwise tries to place robosuite's compilation cache beside
        # the read-only / quota-full shared site-packages tree. Use compute-
