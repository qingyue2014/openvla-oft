...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l3a1", "geometry_sweep"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l3a1_sweep_dx-0.150_dy-0.184_deg-30.0_direction15.0.log",
            "experiments/logs/l3a1_sweep_dx-0.155_dy-0.184_deg-30.0_direction15.0.log",
            "experiments/logs/l3a1_sweep_dx-0.160_dy-0.184_deg-30.0_direction15.0.log",
        ),
    ),
    ("l3a1", "corridor_sweep"): PhaseSpec(
        ...
        artifacts=(
            ...
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-dx-0.160",
        ),
    ),
