...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l3a1", "geometry_sweep"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l3a1_sweep_dx-0.090_dy-0.184_deg-20.0_direction35.0.log",
            "experiments/logs/l3a1_sweep_dx-0.095_dy-0.184_deg-20.0_direction35.0.log",
            "experiments/logs/l3a1_sweep_dx-0.100_dy-0.184_deg-20.0_direction35.0.log",
        ),
    ),
