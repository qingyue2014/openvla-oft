...
sys.argv = [
    ...
    (
        ...
        "momentum_striker_1_main,momentum_relay_1_main,"
    ...
    "--run_id_note", "L3-A4-drawer-momentum-eb-parked-pilot600",
]
...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l3a4", "geometry_trace"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/diagnose_l3a4_candidate.py",
        ),
        artifacts=(
            "experiments/logs/l3a4_candidate_trace.md",
            "experiments/logs/l3a4_candidate_trace.json",
        ),
    ),
    ...
    ("l3a4", "eb_source_pilot"): PhaseSpec(
        command=("python", "-c", L3A4_EB_SOURCE_PILOT),
        count_env="NUM_TRIALS",
        environment=(
    ...
    ("l3a4", "task55_static_probe"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/probe_l3a4_task55_native_chain.py",
            "--fail_on_invalid",
        ),
    ...
    ("l3a4", "task55_vertical_mirror_v3"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/probe_l3a4_task55_vertical_mirror.py",
            "--fail_on_invalid",
        ),
        artifacts=("experiments/logs/l3a4_task55_vertical_mirror_v3",),
    ),
    ("l3a4", "spatial_task1_native_audit"): PhaseSpec(
        command=(
            "python",
    ...
    ("l3a4", "spatial_task1_bowl2_feasibility"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/audit_l3a4_spatial_task1_bowl2_feasibility.py",
        ),
        artifacts=(
            "experiments/logs/l3a4_spatial_task1_bowl2_feasibility",
        ),
    ),
    ("l3a4", "spatial_task1_bowl2_dynamic"): PhaseSpec(
        command=(
            "python",
        ...
        artifacts=(
            "experiments/logs/l3a4_spatial_task1_bowl2_dynamic",
        ),
    ),
    ("l3a4", "spatial_task1_landmark_impact_static"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/audit_l3a4_spatial_task1_landmark_impact.py",
        ),
        artifacts=(
            "experiments/logs/l3a4_spatial_task1_landmark_impact",
        ),
    ),
    ("l3a4", "spatial_task1_vertical_overhang_static"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/audit_l3a4_spatial_task1_vertical_overhang.py",
        ),
        artifacts=(
            "experiments/logs/l3a4_spatial_task1_vertical_overhang",
        ),
    ),
    ("l3a4", "spatial_task1_cookie_goal_plate_static"): PhaseSpec(
        command=(
            "python",
    ...
    ("l3a4", "goal_task4_witness_preflight"): PhaseSpec(
        command=(
            "python",
    ...
    ("l3a4", "goal_task4_fixed_dynamic"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/validate_l3a4_goal_task4_dynamic.py",
            "--stage",
