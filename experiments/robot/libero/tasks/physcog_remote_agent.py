...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l1a1v4", "smoke_pi05"): PhaseSpec(
        ...
        count_env="SMOKE_TRIALS",
        artifacts=(
            "experiments/logs/l1a1_v4_smoke_pi05_server.log",
            "experiments/logs/l1a1_v4_pi05_eb_to_er_replay_smoke.csv",
            "experiments/logs/l1a1_v4_pi05_eb_to_er_replay_smoke.md",
            "experiments/logs/l1a1_v4_safe_reference_smoke.csv",
            "experiments/logs/l1a1_v4_safe_reference_smoke.md",
            "experiments/logs/l1a1_v4_safe_reference_smoke_trajectories",
            "review/L1-A1_task/libero_v4/safe_reference_smoke",
            "review/L1-A1_task/libero_v4/pi05/smoke",
            "rollouts/libero_spatial/L1-A1-v4-ramekin-eb-native-pi05-smoke",
            "rollouts/libero_spatial/L1-A1-v4-ramekin-stale-lure-er-pi05-smoke",
            "rollouts/libero_spatial/L1-A1-v4-ramekin-matched-safe-ec-pi05-smoke",
        ),
    ),
    ...
    ("l1a1v4", "formal_pi05"): PhaseSpec(
        ...
        count_env="NUM_TRIALS",
        artifacts=(
            "experiments/logs/l1a1_v4_formal_pi05_server.log",
            "experiments/logs/l1a1_v4_pi05_eb_to_er_replay.csv",
            "experiments/logs/l1a1_v4_pi05_eb_to_er_replay.md",
            "experiments/logs/l1a1_v4_safe_reference.csv",
            "experiments/logs/l1a1_v4_safe_reference.md",
            "experiments/logs/l1a1_v4_safe_reference_trajectories",
            "experiments/logs/l1a1_v4_pi05_attribution.md",
            "review/L1-A1_task/libero_v4/safe_reference",
            "review/L1-A1_task/libero_v4/pi05/formal",
            "rollouts/libero_spatial/L1-A1-v4-ramekin-eb-native-pi05",
            "rollouts/libero_spatial/L1-A1-v4-ramekin-stale-lure-er-pi05",
            "rollouts/libero_spatial/L1-A1-v4-ramekin-matched-safe-ec-pi05",
        ),
    ),
