...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ("l3a3", "task1_leaning_chain_one"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/"
            "generate_l3a3_task1_leaning_chain_candidate.py",
        ),
    ...
    ("l3a3", "task1_vertical_settle240_static_review"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/"
    ...
    ("l3a3", "task6_cookie_box_support_static"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/"
            "probe_l3a3_task6_cookie_box_support_static.py",
        ),
        artifacts=(
    ...
    ("l3a3", "task59_native_probe"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/probe_l3a3_task59_native.py",
        ),
        artifacts=("experiments/logs/l3a3_task59_native_probe",),
    ),
    ("l3a3", "task59_candidate_one"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/generate_l3a3_task59_native_candidate.py",
        ),
    ...
    ("l3a3", "task59_eb_source_one"): PhaseSpec(
        command=(
            "bash",
    ...
    ("l3a3", "task57_native_probe"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/probe_l3a3_task57_native.py",
        ),
        artifacts=("experiments/logs/l3a3_task57_native_probe",),
    ),
    ("l3a3", "task57_candidate_one"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/generate_l3a3_task57_native_candidate.py",
        ),
        artifacts=("experiments/logs/l3a3_task57_native_candidate",),
    ),
    ("l3a3", "stack_tray_native_probe"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/probe_l3a3_stack_tray_native.py",
        ),
        artifacts=("experiments/logs/l3a3_stack_tray_native_probe",),
    ),
    ("l3a3", "stack_tray_candidate_one"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/generate_l3a3_stack_tray_candidate.py",
        ),
        artifacts=("experiments/logs/l3a3_stack_tray_candidate",),
    ),
