...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l3a1", "corridor_sweep"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l3a1_corridor_dx-0.105_check.md",
            "experiments/logs/l3a1_corridor_dx-0.110_check.md",
            "experiments/logs/l3a1_corridor_dx-0.115_check.md",
            "experiments/logs/l3a1_corridor_dx-0.105_risk_states.hdf5",
            "experiments/logs/l3a1_corridor_dx-0.110_risk_states.hdf5",
            "experiments/logs/l3a1_corridor_dx-0.115_risk_states.hdf5",
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-dx-0.105",
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-dx-0.110",
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-dx-0.115",
        ),
    ),
