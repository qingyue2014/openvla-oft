...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l3a1", "geometry_sweep"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l3a1_sweep_dx-0.155_dy-0.120_deg-20.0_direction-90.0.log",
            "experiments/logs/l3a1_sweep_dx-0.165_dy-0.120_deg-20.0_direction-90.0.log",
            "experiments/logs/l3a1_sweep_dx-0.155_dy-0.100_deg-20.0_direction-90.0.log",
        ),
    ),
    ("l3a1", "corridor_sweep"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l3a1_corridor_direction40_check.md",
            "experiments/logs/l3a1_corridor_direction45_check.md",
            "experiments/logs/l3a1_corridor_direction50_check.md",
            "experiments/logs/l3a1_corridor_direction40_risk_states.hdf5",
            "experiments/logs/l3a1_corridor_direction45_risk_states.hdf5",
            "experiments/logs/l3a1_corridor_direction50_risk_states.hdf5",
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-direction40",
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-direction45",
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-direction50",
        ),
    ),
