...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l1b3_task4", "preflight"): PhaseSpec(
        command=(
            "env",
            "RENDER_GPU_DEVICE_ID=0",
            "SAVE_VIDEO_MODE=none",
        ...
        artifacts=(
            ...
            "experiments/logs/l1b3_task4_candidate_native_preflight.md",
            "experiments/logs/l1b3_task4_candidate_native_preflight.json",
    ...
    ("l1b3_task4", "smoke"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/robot/libero/tasks/l1b3_task4_candidate_anchor_source_pool_er_states.hdf5",
            "experiments/robot/libero/tasks/l1b3_task4_candidate_anchor_source_pool_ec_states.hdf5",
            "experiments/robot/libero/tasks/l1b3_task4_candidate_anchor_source_pool_pairing.json",
            "experiments/robot/libero/tasks/l1b_swept_preview/l1b3_task4_candidate",
            "experiments/logs/l1b3_task4_candidate_native_preflight.md",
            "experiments/logs/l1b3_task4_candidate_native_preflight.json",
            "experiments/logs/l1b3_task4_candidate_anchor_preflight.md",
            "experiments/logs/l1b3_task4_candidate_anchor_preflight.csv",
            "experiments/logs/l1b3_task4_candidate_scene_check.md",
