...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l1b5", "smoke"): PhaseSpec(
        ...
        artifacts=(
            "rollouts/libero_spatial/L1-B5-task6-ramekin-near-target-disruption-v3-eb-smoke-seed42",
            "rollouts/libero_spatial/L1-B5-task6-ramekin-near-target-disruption-v3-er-smoke-seed42",
            "rollouts/libero_spatial/L1-B5-task6-ramekin-near-target-disruption-v3-ec-smoke-seed42",
        ),
    ),
    ("l1b5", "calibration_eb"): PhaseSpec(
        command=(
            "env",
            "RENDER_GPU_DEVICE_ID=1",
        ...
        count_env="NUM_TRIALS",
        artifacts=(
            "rollouts/libero_spatial/L1-B5-task6-ramekin-near-target-disruption-v3-eb-calibration-seed42",
        ),
    ),
    ("l1b5", "replay_calibration"): PhaseSpec(
        command=(
            "env",
            "RUN_ID_SUFFIX=calibration-seed42",
            "bash",
        ...
        artifacts=(
            ...
            "experiments/logs/l1b5_native_gripper_control_replay.md",
            "experiments/logs/l1b5_native_gripper_control_replay.csv",
        ),
    ),
    ("l1b5", "geometry_sweep"): PhaseSpec(
        command=(
            "python",
            ...
            "l1b5_native_gripper",
            "--eb_trajectories",
            "rollouts/libero_spatial/L1-B5-task6-ramekin-near-target-disruption-v3-eb-calibration-seed42/trajectories",
            "--eb_states",
            "experiments/robot/libero/tasks/l1b5_native_gripper_eb_states.hdf5",
            "--fractions",
            "0.25,0.30,0.35,0.40,0.45,0.50",
            "--laterals=-0.06,-0.04,-0.02,0.0,0.02,0.04,0.06",
            "--task_suite_name",
            "libero_spatial",
            "--task_id",
            "6",
            "--out_csv",
            "experiments/logs/l1b5_native_gripper_geometry_sweep.csv",
        ),
        artifacts=(
            "experiments/logs/l1b5_native_gripper_geometry_sweep.csv",
        ),
    ),
    ("l1b5", "geometry_refine"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/search_l1b_native_replay_positions.py",
            "--family",
            ...
            "6",
            "--out_csv",
            "experiments/logs/l1b5_native_gripper_geometry_refine.csv",
        ),
        artifacts=(
            "experiments/logs/l1b5_native_gripper_geometry_refine.csv",
        ),
    ...
    ("l1b5", "formal"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l1b5_native_gripper_control_replay.md",
            "experiments/logs/l1b5_native_gripper_control_replay.csv",
            "experiments/logs/l1b5_attribution.md",
            "experiments/logs/experiment_records.csv",
            "experiments/logs/experiment_records.md",
            "experiments/logs/result_tables.md",
            "rollouts/libero_spatial/L1-B5-task6-ramekin-near-target-disruption-v3-eb-seed42",
            "rollouts/libero_spatial/L1-B5-task6-ramekin-near-target-disruption-v3-er-seed42",
            "rollouts/libero_spatial/L1-B5-task6-ramekin-near-target-disruption-v3-ec-seed42",
        ),
    ),
