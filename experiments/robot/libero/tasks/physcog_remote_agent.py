...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ("l3a2", "task2_native_rebind_static"): PhaseSpec(
        command=(
            "python",
        ...
        artifacts=(
            "experiments/logs/l3a2_task2_native_rebind_static",
        ),
    ),
    ("l3a2", "task1_cantilever_kinematic"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/"
        ...
        artifacts=(
            "experiments/logs/l3a2_task1_cantilever_kinematic",
        ),
    ),
    ("l3a2", "task1_cantilever_static"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/"
        ...
        artifacts=(
            "experiments/logs/l3a2_task1_cantilever_static",
        ),
    ),
    ("l3a2", "task1_a_only_swept_diagnostic"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/"
            "diagnose_l3a2_task1_a_swept_path.py",
        ),
        artifacts=("experiments/logs/l3a2_task1_a_swept_path",),
    ),
    ("l3a2", "task1_diagonal_scan"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/"
            "preflight_l3a2_task1_diagonal_cascade.py",
        ),
        artifacts=("experiments/logs/l3a2_task1_diagonal_cascade",),
    ),
    ("l3a2", "task1_inline_diagonal_scan"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/"
        ...
        artifacts=(
            "experiments/logs/l3a2_task1_inline_diagonal_cascade",
        ),
    ),
    ("l3a2", "task1_native_audit"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/audit_l3a2_task1_native.py",
        ),
        artifacts=("experiments/logs/l3a2_task1_native_audit",),
    ),
    ...
    ("l3a2", "task49_v2_exact_b"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/preflight_l3a2_task49_v2_exact_b.py",
        ),
        artifacts=("experiments/logs/l3a2_task49_v2_exact_b",),
    ),
    ("l3a2", "task33_physical_scan"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/preflight_l3a2_task33_mug_cascade.py",
        ),
        artifacts=("experiments/logs/l3a2_task33_mug_cascade",),
    ),
    ("l3a2", "task33_native_audit"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/audit_l3a2_task33_native.py",
        ),
        artifacts=("experiments/logs/l3a2_task33_native_audit",),
    ),
    ("l3a2", "task49_er_preview"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/preflight_l3a2_task49_stack.py",
        ),
        artifacts=("experiments/logs/l3a2_task49_er_preview",),
    ),
    ("l3a2", "task49_native_preview"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/preview_l3a2_task49_native.py",
        ),
        artifacts=("experiments/logs/l3a2_task49_native_preview",),
    ),
    ...
    ("l3a2", "adaptive_refine"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/"
            "sweep_l3a2_cascade_geometry.py",
            "--adaptive-episode-poses",
            "--adaptive-anchor-x", "0.1078",
            "--adaptive-anchor-y", "0.0484",
            "--adaptive-anchor-yaw-deg", "100.0",
            "--adaptive-position-delta", "0.001",
            "--adaptive-yaw-delta-deg", "1.0",
            "--fail-on-invalid",
        ),
        count_env="NUM_TRIALS",
        artifacts=(
    ...
    ("l3a1", "geometry_sweep"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l3a1_sweep_right_dx0.142_dy-0.060_deg-25.0_direction90.0.log",
            ...
            "experiments/logs/l3a1_sweep_right_dx0.150_dy-0.060_deg-40.0_direction90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.150_dy-0.060_deg-45.0_direction90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.155_dy-0.060_deg-40.0_direction90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.160_dy-0.060_deg-35.0_direction90.0.log",
            "experiments/logs/l3a1_sweep_right_dx0.160_dy-0.060_deg-40.0_direction90.0.log",
        ),
    ),
    ("l3a1", "corner_sweep"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/sweep_l3a1_corner_geometry.py",
        ),
        artifacts=(
            "experiments/logs/l3a1_corner_sweep.md",
            "experiments/logs/l3a1_corner_sweep.csv",
        ),
    ),
    ("l3a1", "edge_sweep"): PhaseSpec(
        command=(
            "python",
            "experiments/robot/libero/tasks/sweep_l3a1_edge_geometry.py",
        ),
        artifacts=(
            "experiments/logs/l3a1_edge_sweep.md",
            "experiments/logs/l3a1_edge_sweep.csv",
    ...
    ("l3a1", "safe_reference"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l3a1_safe_reference_trajectories",
            "experiments/logs/l3a1_safe_reference_videos",
            "experiments/logs/l3a1_causal_reference.md",
            "experiments/logs/l3a1_causal_reference.csv",
        ),
    ),
