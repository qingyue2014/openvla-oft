...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l3a1", "corridor_sweep"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l3a1_corridor_dx-0.080_check.md",
            "experiments/logs/l3a1_corridor_dx-0.100_check.md",
            "experiments/logs/l3a1_corridor_dx-0.120_check.md",
            "experiments/logs/l3a1_corridor_dx-0.080_risk_states.hdf5",
            "experiments/logs/l3a1_corridor_dx-0.100_risk_states.hdf5",
            "experiments/logs/l3a1_corridor_dx-0.120_risk_states.hdf5",
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-dx-0.080",
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-dx-0.100",
            "rollouts/libero_10/L3-A1-drawer-bottle-er-support-removal-corridor-dx-0.120",
        ),
    ),
