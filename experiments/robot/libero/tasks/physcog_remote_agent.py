...
PHASES: Mapping[tuple[str, str], PhaseSpec] = {
    ...
    ("l3a1", "geometry_sweep"): PhaseSpec(
        ...
        artifacts=(
            ...
            "experiments/logs/l3a1_sweep_left_dx-0.148_dy-0.040_deg-43.0_direction-120.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.148_dy-0.040_deg-45.0_direction-120.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.148_dy-0.040_deg-47.0_direction-120.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.153_dy-0.040_deg-43.0_direction-120.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.153_dy-0.040_deg-45.0_direction-120.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.153_dy-0.040_deg-47.0_direction-120.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.158_dy-0.040_deg-43.0_direction-120.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.158_dy-0.040_deg-45.0_direction-120.0.log",
            "experiments/logs/l3a1_sweep_left_dx-0.158_dy-0.040_deg-47.0_direction-120.0.log",
        ),
    ),
