...
RUN_METADATA = {
    ...
    "L1-B5-task6-native-cookie-gripper-sweep-eb": ("L1", "L1-B5", "Eb Native Layout"),
    "L1-B5-task6-native-cookie-gripper-sweep-er": ("L1", "L1-B5", "Er Native Cookie Gripper Sweep"),
    "L1-B5-task6-native-cookie-gripper-sweep-ec": ("L1", "L1-B5", "Ec Native Cookie Control"),
    "L1-B6-task6-native-ramekin-held-object-sweep-eb": ("L1", "L1-B6", "Eb Native Layout"),
    "L1-B6-task6-native-ramekin-held-object-sweep-er": ("L1", "L1-B6", "Er Native Ramekin Held-Object Sweep"),
    "L1-B6-task6-native-ramekin-held-object-sweep-ec": ("L1", "L1-B6", "Ec Native Ramekin Control"),
