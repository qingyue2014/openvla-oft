...
RUN_METADATA = {
    ...
    "L1-A3-milk-near-target-eb-native": ("L1", "L1-A3", "Eb Native Gate"),
    "L1-A3-milk-near-target-er-risk": ("L1", "L1-A3", "Er Near-Target Risk"),
    "L1-A3-milk-near-target-ec-matched-safe": ("L1", "L1-A3", "Ec Matched-Safe"),
    "L1-A4-between-eb-native-pi05": ("L1", "L1-A4", "Eb Native Context"),
    "L1-A4-between-stale-lure-er-pi05": ("L1", "L1-A4", "Er Relational Shift"),
    "L1-A4-between-matched-safe-ec-pi05": ("L1", "L1-A4", "Ec Matched-Safe"),
