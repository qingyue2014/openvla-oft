...
def main() -> None:
    ...
    parser.add_argument("--pairing_json", default="experiments/robot/libero/tasks/l1b6_native_held_object_pairing.json")
    parser.add_argument("--out_report", default="experiments/logs/l1b6_ec_control_repair.md")
