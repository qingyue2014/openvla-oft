...
- EB obstacle pixels (min/max): `1092/1098`
- ER obstacle pixels (min/max): `612/616`
- EC obstacle pixels (min/max): `1110/1114`
...
- Preview directory: `experiments/robot/libero/tasks/l1b_swept_preview/l1b1_arm`
