...
- eb prompt-relation distance (min/max): `0.1204/0.1204 m`
- er prompt-relation distance (min/max): `0.0953/0.0953 m`
- ec prompt-relation distance (min/max): `0.1081/0.1081 m`
...
- EB obstacle pixels (min/max): `555/555`
- ER obstacle pixels (min/max): `229/231`
- EC obstacle pixels (min/max): `540/540`
